...
import { AxisCross, RegistrationMark, SectionLabel, TapeStrip } from '../components/DesignElements';
...
export function Hero({ onApply }: HeroProps) {
  return (
    <section id="about" data-section="about" className="min-h-screen flex items-center px-6 md:pl-12 md:max-[1599px]:pr-16 min-[1600px]:pr-[14%] py-20 relative overflow-hidden">
      <div className="w-full max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          <div className="flex-1 space-y-4 min-w-0">
            <motion.p
              {...anim(0.15)}
              className="font-serif text-ink leading-12"
              style={{
                fontSize: 'clamp(1.5rem, 2.6vw, 2.5rem)',
                fontVariationSettings: '"SOFT" 100, "WONK" 0',
              }}
            >
              for <span className="italic">Frontier Technologies</span><br />&amp; <span className="italic">Creative Arts</span>.
            </motion.p>
          ...
          <motion.div
            ...
            className="relative w-full sm:w-96 xl:w-[520px] sm:shrink-0 lg:mt-12 -rotate-1"
          >
            ...
            <div className="relative bg-white p-3 shadow-[6px_8px_32px_rgba(0,0,0,0.13)]">
              <img
                src="/ft-ldn-hero.png"
